...
C_SRCS += \
D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/usbHID/zbhci_usb_hid.c 
...
zbhci/usbHID/zbhci_usb_hid.o: D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/usbHID/zbhci_usb_hid.c zbhci/usbHID/subdir.mk
	@echo 'Building file: $<'
