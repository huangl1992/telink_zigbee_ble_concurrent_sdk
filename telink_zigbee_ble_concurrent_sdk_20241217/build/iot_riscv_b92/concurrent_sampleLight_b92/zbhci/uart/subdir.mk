...
C_SRCS += \
D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/uart/hci_uart.c 
...
zbhci/uart/hci_uart.o: D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/uart/hci_uart.c zbhci/uart/subdir.mk
	@echo 'Building file: $<'
