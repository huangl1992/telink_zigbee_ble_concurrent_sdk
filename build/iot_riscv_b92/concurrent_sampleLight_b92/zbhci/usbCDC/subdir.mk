...
C_SRCS += \
D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/usbCDC/zbhci_usb_cdc.c 
...
zbhci/usbCDC/zbhci_usb_cdc.o: D:/hl/telink/zigbee_test/telink_zigbee_ble_concurrent_sdk_20241217/zbhci/usbCDC/zbhci_usb_cdc.c zbhci/usbCDC/subdir.mk
	@echo 'Building file: $<'
