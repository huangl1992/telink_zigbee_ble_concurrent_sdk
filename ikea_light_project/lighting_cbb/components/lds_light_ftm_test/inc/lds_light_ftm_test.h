#ifndef _LDS_LIGHT_FTM_TEST_H_
#define _LDS_LIGHT_FTM_TEST_H_
...
#define AGING_FTM_TEST_FINISH_FLAG 	0x00000000  // aging finish
...
typedef enum {
    FTM_AGING_MIN_TEMPERATURE = 0,
	FTM_AGING_DEFAULT_TEMPERATURE,
	FTM_AGING_MEDIUM_TEMPERATURE,
	FTM_AGING_MAX_TEMPERATURE,
	FTM_AGING_FINISH_STAGE,
} LDS_CCT_FTM_AGING_STAGE_E;

typedef enum {
	FTM_AGING_RGBTW_STAGE = 0,
	FTM_AGING_RGB_STAGE,
	FTM_AGING_RGB_MIN_TEMPERATURE,
	FTM_AGING_RGB_DEFAULT_TEMPERATURE,
	FTM_AGING_RGB_MAX_TEMPERATURE,
	FTM_AGING_RGB_MEDIUM_TEMPERATURE,
	FTM_AGING_RGB_FINISH_STAGE,
} LDS_RGB_FTM_AGING_STAGE_E;
...
typedef enum {
	LDS_FTM_RGB_CALI_OK = 0,
	LDS_FTM_RGB_CALI_NG,
	LDS_FTM_RGB_CALI_UNDONE,
} LDS_FTM_RGB_CALI_RESULT_E;
